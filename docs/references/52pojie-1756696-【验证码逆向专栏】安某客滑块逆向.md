...
> **作者**: K哥爬虫 | **发布时间**: 2023-03-10 16:38:00 | **版块**: 『脱壳破解区』 | **查看/回复**: 4961 / 10
> **原文**: [https://www.52pojie.cn/thread-1756696-1-1.html](https://www.52pojie.cn/thread-1756696-1-1.html)

---

*本帖最后由 K哥爬虫 于 2023-3-10 16:45 编辑*

![](https://s1.ax1x.com/2022/11/24/zJk7m6.png)
...
![05](https://s1.ax1x.com/2022/11/24/zJFgGd.png)

`_taN()` 函数是一些 URL，UA 之类的信息，可以写死：

![06](https://s1.ax1x.com/2022/11/24/zJFcPH.png)

往里跟就可以看到 AES 算法了：

![07](https://s1.ax1x.com/2022/11/24/zJFhsP.png)
...
![08](https://s1.ax1x.com/2022/11/24/zJF4qf.png)

![09](https://s1.ax1x.com/2022/11/24/zJFIZ8.png)

解密结果可以看到滑块的图片地址等信息：

![10](https://s1.ax1x.com/2022/11/24/zJFodS.png)

### data 生成

接下来就是 `checkInfoTp` 提交验证了，要搞清楚提交的 `data` 是什么东西，同样搜索打断点，如下图所示 `_5DD` 就是 `data` 值，传过来的。

![11](https://s1.ax1x.com/2022/11/24/zJFTIg.png)

往上跟栈，可以看到 `_Ug0` 里面有个 `track` 参数，这明显就是轨迹了，同样最后的结果经过了 AES 加密。

![12](https://s1.ax1x.com/2022/11/24/zJFHiQ.png)

再往上跟，可以看到 `_Ug0` 由三个参数组成，`x` 是水平滑动的距离，`track` 是轨迹，`p` 是定值。

![13](https://s1.ax1x.com/2022/11/24/zJFbGj.png)
...
![14](https://s1.ax1x.com/2022/11/24/zJFqRs.png)
...
![15](https://s1.ax1x.com/2022/11/24/zJFLzn.png)
