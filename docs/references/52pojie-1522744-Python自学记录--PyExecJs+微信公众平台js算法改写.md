# Python自学记录-PyExecJs+微信公众平台js算法改写

> **作者**: BoBuo | **发布时间**: 2021-10-03 14:19:00 | **版块**: 『编程语言区』 | **查看/回复**: 2515 / 7
> **原文**: [https://www.52pojie.cn/thread-1522744-1-1.html](https://www.52pojie.cn/thread-1522744-1-1.html)
...
#js源文件编译
ctx = node.compile(open(r'D:\代码保存\wechat.js',encoding='utf-8').read())
...
u = -1732584194,
d = 271733878;
for (n = 0; n < t.length; n += 16) a = l(r = a, o = c, i = u, s = d, t[n], 7, -680876936),
...
return function(t, e) {
    ...
    i = [],
    s = [];
    for (i[15] = s[15] = void 0, 16 < o.length && (o = c(o, 8 * t.length)), n = 0; n < 16; n += 1) i[n] = 909522486 ^ o[n],
    s[n] = 1549556828 ^ o[n];
