...
> **作者**: 13955925361 | **发布时间**: 2025-04-29 19:31:00 | **版块**: 『编程语言区』 | **查看/回复**: 1410 / 3
> **原文**: [https://www.52pojie.cn/thread-2028249-1-1.html](https://www.52pojie.cn/thread-2028249-1-1.html)

---

*本帖最后由 13955925361 于 2025-4-29 20:13 编辑*

目前已知第一次发送请求的sign,time，但是做不到表单数据的自动化，
第一次请求的结果中的purl参数和主域名拼接得到第二次请求的网址，
所以说弄清搜索不同歌曲表单数据的变化规律是关键，参数太多。
