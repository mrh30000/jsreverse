...
> **作者**: 鴻渊 | **发布时间**: 2023-11-13 14:28:00 | **版块**: 『编程语言区』 | **查看/回复**: 435 / 2
> **原文**: [https://www.52pojie.cn/thread-1856239-1-1.html](https://www.52pojie.cn/thread-1856239-1-1.html)

---

提取了浏览器淘系发送请求，cookie中带的isg生成和cna；

cna想要获取比较简单，是通过请求js：<https://log.mmstat.com/eg.js>，通过正则提取goldlog.Etag的值即可；

isg生成若是在浏览器中直接使用，可使用第二段js，调用其中的getIsg函数获取；若想直接在程序中直接访问，且程序没有js的window等对象，可使用第一段js，同样调用getIsg函数，即可
...
var k,
  ...
  z = (function () {
    var n = user_agent.match(/Chrome\/(\d*)/);
    return !(n && +n[1] < 80)
  })();
!(function (n) {
  function t(n) {
...
!(function (n) {
  ...
  function o(n, t) {
    return 0 <= n && n <= pppp.l() && 0 <= t && t <= pppp.m()
  }
  function e(n) {
    if (((D = n.isTrusted), true)) {
      var r = n.target,
        a = r.offsetWidth >> 1,
        o = r.offsetHeight >> 1;
      if (!(a < 10 && o < 10)) {
        var e = Math.abs(n.offsetX - a),
          u = Math.abs(n.offsetY - o),
          f = e < 2 && u < 2;
        if ((f && ln++, ln >= 3 && (3 === ln, sn && sn.length < 20))) {
          var l = (f ? '' : '!') + r.tagName;
          sn.push(l)
        }
      }
...
!(function (t) {
  ...
  function c(t, r, i) {
    ...
    return (
      !(!o || !o.set) &&
      ((o.set = a(o.set, i, !1)), true, Object.defineProperty(t, r, o), !0)
    )
  }
  t.ia = -1;
...
!(function (n) {
  ...
  function r(n) {
    ...
    (a[1] = pppp.a()),
      (a[5] = A._()),
      (a[6] = L.ra()),
      (a[8] = pppp.c(user_agent)),
      (a[7] = 0);
  }
  function i(n, r) {
    0 == a[4] && ((a[4] = pppp.a()), (a[3] = t())),
      (a[2] = t()),
      (a[16] = A.$());
    var i = !1;
    if (!A.Z()) {
...
!(function (n) {
  ...
  function r(n) {
    var t = 'h5.m.goofish.com';
    if (A.test(t)) return z.s(n), t;
    var r = t.split('.'),
      i = r.length;
  ...
  function w() {
    E.F(), (z = new x(g));
    var n = new Date(pppp.d() + 15552e6).toUTCString();
    z.x(n), z.A('/');
    var t = z.q();
    t.length > 1 &&
      (k.C('exist_multi_isg'), b(), z.q().length > 0 && k.C('clear_fail'));
    var r = t[0];
    r || (r = pppp.j(g)),
      W.F(r),
      (r = W.sa(!1, !1)),
...
第二种获取isg的方法（该方式直接取自淘系的index.js，只做了参数名重命名）

[JavaScript] *纯文本查看*

```
var p, d = 399, g = "isg", y = window, b = !!y.addEventListener, w = document.getElementsByTagName("head")[0], _ = navigator.userAgent;
!function(n) {
    function t() {
        return 4294967295 * Math.random() >>> 0
    }
    ...
    function p() {
        var n = y.outerWidth;
        return null == n && (n = document.documentElement.clientWidth || document.body.clientWidth),
            n
    }
    function d() {
        var n = y.outerHeight;
        return null == n && (n = document.documentElement.clientHeight || document.body.clientHeight),
            n
    }
    n.a = t;
    var g = /native code/
...
var k, x = function() {
    ...
    return n.prototype.q = function() {
        ...
        n.prototype.s = function(n) {
            ...
            try {
                document.cookie = this.o + n + this.p
            } catch (r) {}
        }
        ,
        n.prototype.w = function() {
...
!function(n) {
    ...
    function c(n, t) {
        var r = [];
        for (var i in n)
            r.push(i + "=" + encodeURIComponent(n[i]));
...
!function(n) {
    ...
    function A() {
        if ("ontouchmove"in document && (p.i(document, "touchmove", v, !0),
            p.i(document, "touchstart", a, !0)),
            p.i(document, "mousemove", m, !0),
            p.i(document, "mousedown", r, !0),
            p.i(document, "click", e, !0),
            p.i(document, "keydown", g, !0),
            p.i(window, "scroll", d, !0),
            p.i(window, "focus", x),
            p.i(window, "blur", z),
            p.i(window, "resize", w),
            w(),
            navigator.getBattery) {
            var n = navigator.getBattery();
            n && (n.then(function(n) {
                Q = n
            })["catch"](function(n) {}),
                cn = !0)
    ...
    (/dingtalk|youku|uczzd\.cn|sm\.cn|uc\.cn/.test(location.hostname) || /iPhone|iPad|Qianniu|DingTalk|Youku|SQREADER/.test(_)) && (un = !1);
    var fn = null
        , sn = []
        , ln = 0;
    n.F = A,
...
!function(n) {
    ...
    function g() {
        return A && ("complete" !== document.readyState || p.d() - E > 1e4 || j.G() || j.H() || j.I() || j.J()) && (A = !1),
            A
    }
    function k() {
...
!function(n) {
    function t() {
        n.fa = r("1688.com,95095.com,a-isv.org,aliapp.org,alibaba-inc.com,alibaba.com,alibaba.net,alibabacapital.com,alibabacloud.com,alibabacorp.com,alibabadoctor.com,alibabagroup.com,alicdn.com,alidayu.com,aliexpress.com,alifanyi.com,alihealth.cn,alihealth.com.cn,alihealth.hk,alikmd.com,alimama.com,alimei.com,alios.cn,alipay-corp.com,alipay.com,aliplus.com,alisoft.com,alisports.com,alitianji.com,alitrip.com,alitrip.hk,aliunicorn.com,aliway.com,aliwork.com,alixiaomi.com,aliyun-inc.com,aliyun.com,aliyun.xin,aliyuncs.com,alizhaopin.com,amap.com,antfinancial-corp.com,antsdaq-corp.com,asczwa.com,atatech.org,autonavi.com,b2byao.com,bcvbw.com,cainiao-inc.cn,cainiao-inc.com,cainiao.com,cainiao.com.cn,cainiaoyizhan.com,cheng.xin,cibntv.net,cnzz.com,damai.cn,ddurl.to,dingding.xin,dingtalk.com,dingtalkapps.com,doctoryou.ai,doctoryou.cn,dratio.com,etao.com,feizhu.cn,feizhu.com,fliggy.com,fliggy.hk,freshhema.com,gaode.com,gein.cn,gongyi.xin,guoguo-app.com,hemaos.com,heyi.test,hichina.com,itao.com,jingguan.ai,jiyoujia.com,juhuasuan.com,koubei-corp.com,kumiao.com,laifeng.com,laiwang.com,lazada.co.id,lazada.co.th,lazada.com,lazada.com.my,lazada.com.ph,lazada.sg,lazada.vn,liangxinyao.com,lingshoujia.com,lwurl.to,mashangfangxin.com,mashort.cn,mdeer.com,miaostreet.com,mmstat.com,mshare.cc,mybank-corp.cn,nic.xin,pailitao.com,phpwind.com,phpwind.net,saee.org.cn,shenjing.com,shyhhema.com,sm.cn,soku.com,tanx.com,taobao.com,taobao.org,taopiaopiao.com,tb.cn,tmall.com,tmall.hk,tmall.ru,tmjl.ai,tudou.com,umeng.co,umeng.com,umengcloud.com,umsns.com,umtrack.com,wasu.tv,whalecloud.com,wrating.com,[url=http://www.net.cn]www.net.cn[/url],xiami.com,ykimg.com,youku.com,yowhale.com,yunos-inc.com,yunos.com,yushanfang.com,zmxy-corp.com.cn,zuodao.com"),
            n.ga = r("127.0.0.1,afptrack.alimama.com,aldcdn.tmall.com,delivery.dayu.com,hzapush.aliexpress.com,local.alipcsec.com,localhost.wwbizsrv.alibaba.com,napi.uc.cn,sec.taobao.com,tce.alicdn.com,un.alibaba-inc.com,utp.ucweb.com,ynuf.aliapp.org"),
            n.ha = r("akamaized.net,alibaba-inc.com,alicdn.com,aliimg.com,alimama.cn,alimmdn.com,alipay.com,alivecdn.com,aliyun.com,aliyuncs.com,amap.com,autonavi.com,cibntv.net,cnzz.com,criteo.com,doubleclick.net,facebook.com,facebook.net,google-analytics.com,google.com,googleapis.com,greencompute.org,lesiclub.cn,linezing.com,mmcdn.cn,mmstat.com,sm-tc.cn,sm.cn,soku.com,tanx.com,taobaocdn.com,tbcache.com,tbcdn.cn,tudou.com,uczzd.cn,umeng.com,us.ynuf.aliapp.org,wrating.com,xiami.net,xiaoshuo1-sm.com,yandex.ru,ykimg.com,youku.com,zimgs.cn")
    }
    function r(n) {
...
!function(n) {
    ...
    function r(n) {
        ...
        for (var a = 2; a <= i && (t = r.pop() + "." + t,
            z.y(t),
            z.s(n),
            !(t in E.fa || t in E.ga || t in E.ha)) && z.r() !== n; a++)
            ;
        return t
    }
    function i(n) {
    ...
    function v(n) {
        ...
        return h(i, y.__sufei_point_list) ? (m(n, 0),
            !1) : !t(r, E.ha) && (!(r in E.ga) && (!/\/gw-open\/|\/gw\/|ascp\.alibaba\.com/.test(i) && (!h(i, y.__sufei_ignore_list) && (m(n, 0),
            !1))))
    }
    function d(n) {
    ...
    function w() {
        E.F(),
            z = new x(g);
        var n = new Date(p.d() + 15552e6).toUTCString();
        z.x(n),
            z.A("/");
        var t = z.q();
        t.length > 1 && (k.C("exist_multi_isg"),
            b(),
        z.q().length > 0 && k.C("clear_fail"));
        var r = t[0];
        r || (r = p.j(g)),
            W.F(r),
            r = W.sa(!1, !1),
...
!function(n) {
    ...
    function i(n) {
        var t = y.Element;
        t ? T.ja(t.prototype, n, a) : (T.ja(w, n, a),
            T.ja(document.body, n, a))
    }
    function a(n) {
        var t = n[0];
        t && "SCRIPT" === t.tagName && o(t.src)
...
!function(n) {
    ...
    function e() {
        f = document.getElementsByTagName("base"),
            c = t(location),
            p.i(document, "click", a),
            p.i(document, "submit", o);
        var n = y.HTMLFormElement;
        n && T.ja(n.prototype, "submit", function(n, t) {
            var r = t;
            S.va(r.getAttribute("action")),
                s.da(r, ++m)
        })
    }
    var c, f, s = new F, m = 0;
...
!function(n) {
    function t() {
        r(),
        /Mobile/.test(_) && (i(),
        a() || p.i(document, "DOMContentLoaded", a))
    }
    function r() {
        T.ja(y, "fetch", function(n) {
            var t = n[0]
                , r = n[1];
            "string" == typeof t && S.va(t) && (r = r || {},
        ...
        if (n) {
            ...
            T.ja(n.windvane, "call", function(n) {
                if ("MtopWVPlugin" === n[0] && "send" === n[1]) {
                    var r = n[2];
                    if (t) {
                        (r.ext_headers || {})["X-Sufei-Token"] = W.sa(!0, !1)
                    } else
                        S.ta()
                }
            })
