...
> **作者**: 天空宫阙 | **发布时间**: 2020-02-09 16:23:00 | **版块**: 『编程语言区』 | **查看/回复**: 6095 / 17
> **原文**: [https://www.52pojie.cn/thread-1101196-1-1.html](https://www.52pojie.cn/thread-1101196-1-1.html)
...
功能是按song\_id抓取最多2000条评论，存入mongodb（一开始想爬40万条的所以选择数据库）

可利用mongodb的查询语句查询定 userId 的评论

{"userId":123}    # 精确查找userId为123的评论

![](https://attach.52pojie.cn/forum/202002/09/161741i1ayxezoc029c6ai.png)

{"content":{"$regex":"123"}}   #模糊查找评论内容包含123字符的评论

![](https://attach.52pojie.cn/forum/202002/09/161733gwfmztma2bfovf45.png)
...
可扩展为查询某用户的评论若该用户近期有评论，被评论歌曲评论总数未超过2000，大概率可以查到，反之亦反
（自己扩展吧song\_id可从，用户动态里分享的歌曲，听歌排行榜歌曲（周榜及总榜），收藏的歌曲及创建歌单内的歌曲，收藏歌单的歌曲中获取）