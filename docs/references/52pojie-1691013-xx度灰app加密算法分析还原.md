...
> **作者**: red1y | **发布时间**: 2022-09-21 21:32:00 | **版块**: 『移动安全区』 | **查看/回复**: 22583 / 164
> **原文**: [https://www.52pojie.cn/thread-1691013-1-1.html](https://www.52pojie.cn/thread-1691013-1-1.html)
...
3. 跟踪`w5()`
   ...
      v2.put("_ver", "v1");
      v2.put("data", v5);
      v2.put("sign", this.j(a.e("_ver=v1&data=" + v5 + "&timestamp=" + "1663503240" + this.e)));
      return v2.toString();
   }
   ```
