...
> **作者**: pzx521521 | **发布时间**: 2024-10-22 12:39:00 | **版块**: 『编程语言区』 | **查看/回复**: 4089 / 17
> **原文**: [https://www.52pojie.cn/thread-1974598-1-1.html](https://www.52pojie.cn/thread-1974598-1-1.html)
...
* GET[主页](https://www.52pojie.cn/fanyi.baidu.com),从Set-Cookie获取BAIDUID
* 通过GET[主页](https://www.52pojie.cn/fanyi.baidu.com) 携带BAIDUID获取token
...
* golang中使用的是[OTTO](https://www.52pojie.cn/github.com/robertkrimen/otto)解析json,本来想让chatGPT直接把js转成golang的,
  但是他转的有问题(calsign\_chatgpt\_err.go),懒得一点一点跟.放弃,直接使用原生js
