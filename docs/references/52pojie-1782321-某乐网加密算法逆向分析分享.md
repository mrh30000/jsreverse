...
> **作者**: ajian51168 | **发布时间**: 2023-05-06 23:51:00 | **版块**: 『脱壳破解区』 | **查看/回复**: 4094 / 14
> **原文**: [https://www.52pojie.cn/thread-1782321-1-1.html](https://www.52pojie.cn/thread-1782321-1-1.html)

---

初学逆向，看到之前大佬的逆向帖子：<https://www.52pojie.cn/thread-1131554-1-1.html>，准备拿其练手。
其中某某街已经倒闭，某乐网还在，这里就拿某乐练手。
...
<input type="text" placeholder="输入内容，使用某乐的rsa加密输出" id="input" style="width:500px;"> <button>确定</button>
```
