# 【JS 逆向百例】拉勾网爬虫，traceparent、_lg_stoken_、X-S-HEADER 等参数分析

> **作者**: K哥爬虫 | **发布时间**: 2023-04-14 17:51:00 | **版块**: 『脱壳破解区』 | **查看/回复**: 6236 / 30
> **原文**: [https://www.52pojie.cn/thread-1773958-1-1.html](https://www.52pojie.cn/thread-1773958-1-1.html)

---

![](https://s2.loli.net/2022/03/10/8jxX4wDZiR5HfuP.png)

> K哥爬虫，持续分享爬虫进阶、JS/安卓逆向等技术干货！
...
* jsencrypt 这个库，本地运行可能会报错 `window is not defined`，在 \node\_modules\jsencrypt\bin\jsencrypt.js 源码中加入 `var window = global;` 即可，这是实现 RSA 加密的库，当然还有很多其他实现方法或者库，都可以。
