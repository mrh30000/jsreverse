# 用Babel解析AST处理OB混淆JS代码：去除控制流平坦化、处理常量串隐藏和其他通用操作

> **作者**: hans7 | **发布时间**: 2022-10-16 20:04:00 | **版块**: 『脱壳破解区』 | **查看/回复**: 12717 / 52
> **原文**: [https://www.52pojie.cn/thread-1700036-1-1.html](https://www.52pojie.cn/thread-1700036-1-1.html)

---

*本帖最后由 hans7 于 2023-4-10 01:45 编辑*
...
#### 动态指定执行命令更好的做法（2）%npm*config*<参数名>%
...
`src/switch_cff_demo.ts`的骨架基本上和`src/check_pass_demo.ts`类似，只不过更完善。这表明我的代码有一定的通用性。[src/switch\_cff\_demo.ts](https://github.com/Hans774882968/control-flow-flattening-remove-public/blob/main/src/switch_cff_demo.ts)：
