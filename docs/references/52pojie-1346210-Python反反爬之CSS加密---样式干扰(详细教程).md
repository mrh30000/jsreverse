...
> **作者**: Java_S | **发布时间**: 2021-01-07 21:55:00 | **版块**: 『脱壳破解区』 | **查看/回复**: 14275 / 12
> **原文**: [https://www.52pojie.cn/thread-1346210-1-1.html](https://www.52pojie.cn/thread-1346210-1-1.html)
...
个人博客网站:[www.syjun.vip](https://www.syjun.vip)

### 题目

![](https://syjun.vip/usr/uploads/2021/01/2274521164.jpg)
题目网址,[点我去刷题](http://match.yuanrenxue.com/match/4)
...
通过上面的代码,我们可以知道网页通过ajax的方式请求了[<http://match.yuanrenxue.com/api/match/4>]
...
[scode type="blue"]获取到密文后,我们就可以通过对比密文,来确定是否是真正显示的图片,从而得出结果[/scode]
...
最后,我们就可以通过根据**j\_key**和**每个图片对应的密文值**,确定出要被用的所以**数字子图片**,和相**对位置的偏移量**
